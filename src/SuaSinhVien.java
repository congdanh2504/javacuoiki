...
public class SuaSinhVien extends JFrame implements MouseListener{
	...
	public SuaSinhVien() {
		...
		try {
			...
			btnsua.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					try {
						...
						new ChinhSinhVien(st.get(0).toString(),st.get(1).toString(),st.get(2).toString(),st.get(3).toString(),st.get(4).toString(),st.get(5).toString(),st.get(6).toString(),SuaSinhVien.this);	
			...
			btnchen.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					new ChenSinhVien(SuaSinhVien.this);
				}
			});
